...
const DataSiswa = () => {
  ...
  const fetchKelas = async () => {
    try {
      const res = await axios.get('https://spp-payment-api-rayyan5038480-05ynou93.leapcell.dev/api/v1/treasurer/classes', {
        headers: {
  ...
  const fetchData = async () => {
    try {
      const res = await fetch ("https://spp-payment-api-rayyan5038480-05ynou93.leapcell.dev/api/v1/treasurer/students", {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
        },
 ...
 const handleTambah = async () => {
  ...
  if (formValues) {
    try {
      await axios.post('https://spp-payment-api-rayyan5038480-05ynou93.leapcell.dev/api/v1/treasurer/students', formValues, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json"
        }
 ...
 const handleEdit = async (item) => {
  ...
  if (formValues) {
    try {
      const res = await fetch(`https://spp-payment-api-rayyan5038480-05ynou93.leapcell.dev/api/v1/treasurer/students/${item.id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
...
const handleDelete = async (id) => {
  ...
  if (confirm.isConfirmed) {
    try {
      const res = await fetch(`https://spp-payment-api-rayyan5038480-05ynou93.leapcell.dev/api/v1/treasurer/students/${id}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
        },
